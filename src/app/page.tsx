...
export default function Page() {
  ...
  const frontendSkills = [
    ...
    { name: "CSS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg", color: "from-blue-500 to-cyan-500" },
    { name: "React", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg", color: "from-cyan-500 to-blue-500" },
    { name: "Next.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg", color: "from-gray-700 to-gray-900" },
    { name: "React Native", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg", color: "from-purple-500 to-pink-500" }
  ];

  const backendSkills = [
    { name: "Laravel", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/laravel/laravel-original.svg", color: "from-red-600 to-orange-600" },
    { name: "Prisma", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/prisma/prisma-original.svg", color: "from-indigo-500 to-purple-500" },
    { name: "MySQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg", color: "from-blue-600 to-blue-400" },
    { name: "PostgreSQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg", color: "from-blue-700 to-indigo-600" },
    { name: "Supabase", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/supabase/supabase-original.svg", color: "from-green-500 to-emerald-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 relative overflow-hidden">
      {/* Enhanced space background with smooth animations */}
      {mounted && (
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8 relative">
              {/* Profile Photo Container with smooth animations */}
              <div className="relative w-40 h-40 mx-auto group">
                {/* Rotating gradient border */}
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-violet-500 to-purple-500 rounded-full animate-spin-slow opacity-75 blur-sm"></div>
                {/* Profile photo */}
            ...
            <div className="h-16 mb-8 overflow-hidden px-4">
              <p className={`text-2xl sm:text-3xl text-purple-300 transition-all duration-500 ease-in-out transform ${
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-purple-600/20 to-violet-600/20 rounded-2xl blur-2xl"></div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <p className="text-gray-300 leading-relaxed text-lg">
                    Hello! I'm Muhammad Esa Pungky Kristanto, a passionate <span className="text-purple-400 font-semibold">Full Stack Developer</span> with 
                    a keen eye for creating seamless digital experiences. My journey in tech started 3 years ago, 
                    and since then, I've been dedicated to crafting elegant solutions to complex problems.
                  </p>
                  <p className="text-gray-300 leading-relaxed text-lg">
                    I specialize in building <span className="text-purple-400 font-semibold">modern web applications</span> using 
                    cutting-edge technologies like React, Next.js, and Laravel. Whether it's a responsive website, 
                    a complex web application, or a mobile app, I bring creativity and technical excellence to every project.
                  </p>
                </div>
                ...
                <div className="pt-6 border-t border-purple-900/30">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div 
                        key={index}
                        className="flex items-center gap-2 text-gray-300 hover:text-purple-300 transition-colors duration-300"
                      >
        ...
        {/* Skills Section with Frontend and Backend separation */}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 transition-all duration-300 group-hover:gap-3"
                    >
                      View Project 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              <a
                ...
                className="flex items-center gap-3 bg-gray-900/50 backdrop-blur border border-purple-900/30 px-8 py-4 rounded-xl hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-1 group"
              >
              ...
              <a
                href="https://github.com/ganasman"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-gray-900/50 backdrop-blur border border-purple-900/30 px-8 py-4 rounded-xl hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-1 group"
              >
              ...
              <a
                href="https://linkedin.com/in/muhammad-esa-pungky-kristanto-458a78378"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-gray-900/50 backdrop-blur border border-purple-900/30 px-8 py-4 rounded-xl hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-1 group"
              >
      ...
      {/* Fullscreen Certificate Modal with smooth transition */}
      {fullscreenImage && (
        <div
